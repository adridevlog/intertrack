...
export default function InternshipBoard({ internship }) {
  ...
  return (
    <div className="flex flex-col p-6 border border-slate-200 bg-white rounded-xl gap-1 cursor-pointer hover:shadow-2xl  transition-all duration-300 hover:-translate-y-2 hover:bg-cyan-50 group">
      <div className="flex flex-row justify-between">
        ...
        <div className="border border-amber-300 text-amber-700  px-2 py-1 rounded-lg bg-amber-50 font-semibold flex flex-row gap-1 items-center">
          ...
          <div className="text-md">{averageScore.toFixed(1)}</div>
        </div>
      </div>
