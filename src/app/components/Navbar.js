  ...
  return (
    <nav className="flex items-center flex-row justify-between p-6  bg-white border-b-2 border-slate-200 font-sans">
      ...
      <div className="flex flex-row items-center gap-4">
        ...
        <button className="h-11 flex flex-row bg-indigo-600 rounded-4xl px-4 py-2 text-lg font-bold gap-4 align-center cursor-pointer hover:bg-indigo-700 transition-colors">
